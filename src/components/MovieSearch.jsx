    ...
    <div className="flex flex-col gap-4 h-full">
      <div className="flex gap-3">
        <input
          ...
          autoFocus
          className="flex-1 bg-white/10 rounded-xl px-5 py-4 text-xl text-white placeholder-white/30 outline-none focus:ring-1 focus:ring-white/30"
        />
        {isSupported && (
          <button
        ...
        <button
          ...
          disabled={loading}
          className="px-6 py-4 bg-blue-500 hover:bg-blue-600 rounded-xl text-lg font-medium text-white shrink-0"
        >
          {loading ? '...' : 'Chercher'}
        </button>
      </div>
